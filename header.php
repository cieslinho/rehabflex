...
<body <?php body_class();?>>
    ...
    <nav class="nav">
        <div class="nav__top">
            <div class="nav__socials">
                <div>
                    <a href="https://www.facebook.com/profile.php?id=61559141819931" class="social">
            ...
            <div class="nav__texts">
                <div>
                    <p>zadzwoń do nas</p>
                    <a href="tel:+48501483238">
                ...
                <div>
                    <p>napisz do nas</p>
                    <a href="mailto:kontakt@rehabflex.pl">

                        <svg width="800px" height="800px" viewBox="0 -3.5 32 32" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                ...
                                <g id="Icon-Set-Filled" sketch:type="MSLayerGroup"
                                    transform="translate(-414.000000, -261.000000)" fill="#fff">
                                    <path
            ...
            <div class="nav__navbar">
                <a href="/" class="nav__brand">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-blue.png"
                        alt="Rehabflex Szyny CPM Opole" alt="">
                </a>
                <?php wp_nav_menu(
            array(
                'theme_location' => 'rehabflex_main_menu',
    ...
    ?>
        ...
        <div class="nav__bottom">
            <a href="#kontakt" class="nav__reservation">wynajmij</a>
        </div>
